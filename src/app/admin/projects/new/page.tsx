...
/**
 * @description 새 프로젝트를 작성·저장하기 위한 폼 콘텐츠입니다.
 * @returns {JSX.Element} 프로젝트 작성 폼 컴포넌트.
 */
function NewProjectContent() {
   ...
   * @returns {Promise<string>} 생성된 요약 문자열.
   */
   ...
   * @returns {Promise<string>} 추출된 키워드 문자열.
   */
  ...
  useEffect(() => {
    /**
     * @description 프로젝트에 활용할 태그 목록을 불러옵니다.
  ...
  /**
   * @description 프로젝트 폼을 검증하고 저장 요청을 보냅니다.
   * @returns {Promise<void>}
   */
...
/**
 * @description 새 프로젝트 작성 페이지를 렌더링합니다.
 * @returns {JSX.Element} 프로젝트 작성 페이지.
 */
